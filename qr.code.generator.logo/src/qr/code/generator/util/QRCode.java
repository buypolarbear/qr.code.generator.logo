package qr.code.generator.util;
...
public class QRCode {
     ...
     */
    public BufferedImage createImage(int cellSize, int margin, String fileInputPath) throws IOException {
        ...
        if(fileInputPath != null){
        	...
        	if(fileInput.exists()){
        		...
        		if(bufferedImage != null){
        			...
        			int w = imageSize/5 > bufferedImage.getWidth() ? bufferedImage.getWidth() : imageSize/5;
        			int h = imageSize/5 > bufferedImage.getWidth() ? bufferedImage.getWidth() : imageSize/5;
